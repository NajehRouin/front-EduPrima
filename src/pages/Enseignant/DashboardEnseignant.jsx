  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <header className="bg-blue-600 text-white p-4 flex justify-between items-center relative">
        <h1 className="text-lg font-bold">Espace Enseignant</h1>
      ...
      <div className="flex flex-1">
        ...
        >
          <nav>
            ...
            <Link
              to="/enseignant/dashboard/cours"
              className={`block py-2.5 px-4 rounded transition duration-200 ${
                isActive("/enseignant/dashboard/cours")
                  ? "bg-blue-600 text-white"
                  : "hover:bg-blue-500 hover:text-white"
              }`}
            >
            ...
            <Link
              to="/enseignant/dashboard/chat"
              className={`block py-2.5 px-4 rounded transition duration-200 ${
                isActive("/enseignant/dashboard/chat")
                  ? "bg-blue-600 text-white"
                  : "hover:bg-blue-500 hover:text-white"
              }`}
            >
      ...
      <footer className="bg-blue-600 text-white p-4 text-center">
        &copy; {new Date().getFullYear()} Teacher Dashboard. Tous droits
        réservés.
      </footer>
    </div>
  );
